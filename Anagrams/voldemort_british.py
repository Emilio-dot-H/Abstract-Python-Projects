...
def main():
	...
	name = input("Enter word to descramble: ")
	name = name.lower()
...
# CREATES LIST OF WORDS THAT ARE EQUAL IN LENGTH TO THE 'NAME' VAR.
...
# GENERATE C-V MAPS FROM THE WORDS IN WORD_LIST
def cv_map_words(word_list):
	"""Map letters in words to consonnant & vowels."""
	vowels = 'aeiouy'
	cv_mapped_words = []
...
#Defines the trigram_filter() function
...
# Defines the letter_pair_filter() function
